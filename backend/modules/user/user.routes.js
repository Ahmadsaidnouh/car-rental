...
const { getAvailableCars, getAvailableCars1, getCarStatus, getDailyPayments, getAllUserReservations, getCarSpecs, getUserId, createReservation, getUserReservs, cancelReservation, pickReservation, getTotalPayment, createPayment, rechargeBalance, addUser, getAllReservations, getAllCarReservations, addCar, editCar, getAdminId } = require("./controller/user.controller")
...
router.post("/getAvailableCars1", getAvailableCars1)
